...
struct MIDITOR
{
    ...
    enum {UseInternalTime=-1,MaxWorkMemory=(1<<24),MaxMacros=(1<<20),MaxSavedTimes=(1<<16),MaxRemaps=128,MidTicksPerQuarterNote=1024};
